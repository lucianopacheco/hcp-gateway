...
import LocationUpdateComponent from '@/entities/reservation/location/location-update.vue';
import LocationClass from '@/entities/reservation/location/location-update.component';
