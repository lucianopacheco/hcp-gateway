...
import LocationDetailComponent from '@/entities/reservation/location/location-details.vue';
import LocationClass from '@/entities/reservation/location/location-details.component';
